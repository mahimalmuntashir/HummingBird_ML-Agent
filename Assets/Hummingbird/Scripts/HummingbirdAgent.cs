...
public class HummingbirdAgent : Agent
{
    ...
    /// 
    /// Note: Using continuous actions instead of vector actions (vector actions are deprecated)
    /// 
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        // (+1 means that the beak tip is directly infront of the flower, -1 means directly behind)
        sensor.AddObservation(Vector3.Dot(toFlower.normalized, -nearestFlower.FlowerUpVector.normalized));

        // Observe a dot product that indicates whether the beak is pointing toward the flower (1 Observation)
        // (+1 means that the beak is pointing directly at the flower, +1 means directly away from the flower)
    ...
    /// </summary>
    /// <param name="inFrontOfFlower">Whether to choose a spot infront of a flower</param>
    ...
    private void MoveToSafeRandomPosition(bool inFrontOfFlower)
    {
        ...
        while (!safePositionFound && attemptsRemaining > 0)
        {
            ...
            if (inFrontOfFlower)
            {
                ...
                // Point beak at flower (bird's head is center of treanform)
            ...
            else
            {
                ...
                // Pick a random direcction rotated around the y axis
