...
{
    // The diameter of the area where the agent and the flowers can be 
    ...
    // A lookup dictionary for looking up a flower from a nectar collier
    ...
    /// <summary>
    /// Gets the <see cref="Flower"/> that a nectar collider belons to
    /// </summary>
        ...
        for (int i = 0; i < parent.childCount; i++)
        {
            ...
            else
            {
                ...
                if (flower != null)
                {
                    ...
                    // Add the nectar collider to the lookup dictoinary
